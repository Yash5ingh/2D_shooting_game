...
while run:
    ...
    if canshoot:
        if ebulletfired == "no":
            bulletsound = mixer.Sound("laser.mp3")
            bulletsound.play()
            if enemyx - 64 < playerx < enemyx + 64:
                if playery > enemyy:
                    ebulletmovex = 0
                    ebulletmovey = playerspeed * 4
                    ebulletx = enemyx + 24
                    ebullety = enemyy + 24
                ...
                if playery < enemyy:
                    ...
                    ebullety = enemyy + 24
                    ebullet(ebulletx, ebullety)
            if enemyy - 64 < playery < enemyy + 64:
                if playerx > enemyx:
                    ebulletmovex = playerspeed * 4
                    ebulletmovey = 0
                    ebulletx = enemyx + 24
                    ebullety = enemyy + 24
                    ebullet(ebulletx, ebullety)
            ...
            if playerx > enemyx + 64 and playery > enemyy + 64:
                ebulletmovex = playerspeed * 4
                ebulletmovey = playerspeed * 4
                ebulletx = enemyx + 24
                ebullety = enemyy + 24
